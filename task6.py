...
min= abs(int(input("Unesi broj: "))) # korisnik unosi na koliko najmanje casova je morao da prisustvuje student
...
for linija in sve_linije:
    ...
    ime_studenta = str(student_i_broj[0]) # ime studenta je str
    broj_casova = int(student_i_broj[1])  # broj casova je cijeli broj

    if broj_casova < min: # za svaku od linija kroz koju prodjemo, ako je broj casova u toj liniji manji od mimimalnog broja casova
